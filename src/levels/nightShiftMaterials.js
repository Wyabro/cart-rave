...
export function createNightShiftMaterialBundle() {
  ...
  const materials = {
    ...
    skylineCore: createPhysicalMaterial({ color: 0xffffff, metalness: 0.08, roughness: 0.9 }),
    skylineExtended: createPhysicalMaterial({ color: 0xffffff, metalness: 0.04, roughness: 0.94 }),
