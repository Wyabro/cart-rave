    ...
    shader.fragmentShader = shader.fragmentShader
      ...
      .replace(
        ...
        [
          ...
          "\t\t// * rippleN is accumulated entirely in WORLD space: the impact term is a",
          "\t\t// * vWaterWorldPos-derived radial direction, and the caustic term is a world-XZ",
          "\t\t// * tilt. But at <normal_fragment_maps> three's `normal` is in VIEW space, so",
          "\t\t// * adding it raw meant the bump itself rotated with the camera instead of",
          "\t\t// * staying put in the world — crest highlights swam as you turned. viewMatrix",
          "\t\t// * is orthonormal, so mat3() of it is the correct direction transform and no",
          "\t\t// * inverse-transpose is needed. Do not 'simplify' this back.",
          "\t\tnormal = normalize( normal + mat3( viewMatrix ) * rippleN );",
          "\t}",
