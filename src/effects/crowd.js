/**
 * crowd.js — Classic-Record rave dressing: instanced crowd (cart / person / glowstick
 * silhouettes), glow ring, searchlights, stadium bowl, and the crowd dance update.
 *
 * Extracted from src/effects.js (EFFECTS-SPLIT-1). Cross-cutting visibility / quality
 * (setRaveExtrasVisible, applyRaveExtrasQuality) stay in effects.js and read this
 * module's state through the exported live bindings below.
 */
...
import { disposeObject3D } from "./meshHelpers.js";
...
export { crowdLayers, crowdCarts, crowdGlow, stadiumGroup, crowdSearchlightEntries, crowdPointLightEntries, applyCrowdBudget };
