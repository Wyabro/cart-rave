...
**GAMEPAD-FRIENDS-SEATED-1** — controller is glitchy after seating in Friends lobby.
...
1. **GAMEPAD-FRIENDS-SEATED-1** — controller nav after seating in Friends lobby. Plan → ack before a lever.
