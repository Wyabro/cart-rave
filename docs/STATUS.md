...
**SITE-TRUST-1** shipped 09-14 — prod `25bf1b38` Worker
`2ac86fc0-f463-4f69-88cf-71b720fb903f`. Privacy, terms, contact, saved
analytics choice (on by default), branded 404, smaller share PNG.
Publisher: Redshift Studios. Support: redshiftstudiossupport@gmail.com.
Owed: **SITE-TRUST-PT-1**. Checks: QA 2,432/2,432; post-ship VERIFY_OK
entry `/assets/index-DuRqnkJB.js`; privacy/terms 200; branded 404.
...
1. **SITE-TRUST-PT-1** owed on prod `25bf1b38`. Then Block 1 High: **CG-COVERS-1**.
