...
- [ ] **NH-SMOOTH** non-host driven cart glides — v1 shipped `34b240d` / `index-CaoV7WsD.js` (better, still janky); **v2 coded unpushed** (cap-82)
- [ ] P5/P6 taste — later
...
| **NH-SMOOTH** | **Non-host driven-cart glide** | ▶️ **v2 coded unpushed** (v1 better/not enough; cap-82) |
...
1. **NH-SMOOTH v2:** ship on “ship it” → hard-refresh → joiner drive/combat pass/fail.
...
2026-07-20 (NH-SMOOTH v2 coded — **unpushed**) — Retest fail: “better but still janky.” Cap-82 `34b240d` joiner: snap clean, errMax **12.3m**, **2 teleports**, pending 9. v2: per-snap add cap 0.45m, debt clamp (not zero), speed-capped ease 5 m/s / 4 rad/s, maxCorrectionM 4→6.
