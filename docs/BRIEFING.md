...
> Generated 2026-08-15 at commit `cb6c6e6` on `cart-clash`. If docs/STATUS.md's digested sections have changed since, `npm run briefing:check` (inside `npm run qa`) fails until this is regenerated.
> Source digest: `992debc5`
...
PATTERNS-UI-4-PT-1 — local: hard-refresh and test the medium Maze, Honeycomb, and Cubes scale. Production after `ship it`
