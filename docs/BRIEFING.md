...
> Generated 2026-08-15 at commit `4d96faf` on `cart-clash`. If docs/STATUS.md's digested sections have changed since, `npm run briefing:check` (inside `npm run qa`) fails until this is regenerated.
> Source digest: `70210ed8`
...
PATTERNS-UI-2-PT-1 — production: nine patterns, locks, multicolor cart/preview, NPC rolls, controller path
