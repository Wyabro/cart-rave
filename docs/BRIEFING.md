...
> Generated 2026-08-15 at commit `0f90051` on `cart-clash`. If docs/STATUS.md's digested sections have changed since, `npm run briefing:check` (inside `npm run qa`) fails until this is regenerated.
> Source digest: `3acf6b18`
...
PATTERNS-UI-2-PT-1 — local: nine patterns, locks, multicolor cart/preview, NPC rolls, controller path. Production after `ship it`
