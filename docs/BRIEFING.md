...
> Generated 2026-09-22 at commit `71457b20` on `HEAD`. If docs/STATUS.md's digested sections have changed since, `npm run briefing:check` (inside `npm run qa`) fails until this is regenerated.
> Source digest: `be97a080`
...
- **NET-LAG-1** Friends/QP lag + rubber-band (F8 both machines) — split shipped `71457b20`; prod QP 6/6 + Friends 14/14 on retry; local prediction 13.9 ms, active ack avg 56.2…
