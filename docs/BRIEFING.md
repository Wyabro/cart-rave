...
> Generated 2026-08-17 at commit `ae9391be` on `cart-clash`. If docs/STATUS.md's digested sections have changed since, `npm run briefing:check` (inside `npm run qa`) fails until this is regenerated.
> Source digest: `22b2dde8`
...
Playtest INPUT-LOCK-PT-1 · INPUT-LOCK-PT-2 · SD-WIN-CREDIT-PT-1 · THOST-CEILING-PT-1 after ship
