...
> Generated 2026-08-10 at commit `3cefb9b` on `cart-clash`. If docs/STATUS.md's digested sections have changed since, `npm run briefing:check` (inside `npm run qa`) fails until this is regenerated.
> Source digest: `b850b795`
...
NOW: NPC-BOOST-2 Wave 2 — make NPC charge-ups audible to the host and Friends clients. Code is local; QA/build and a new explicit ship authorization remain
