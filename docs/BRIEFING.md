...
> Generated 2026-08-05 at commit `7f20e8e` on `cart-clash`. If docs/STATUS.md's digested sections have changed since, `npm run briefing:check` (inside `npm run qa`) fails until this is regenerated.
> Source digest: `01252dc2`
...
- **FIX-EMISSIVE** Non-patterned carts read blown out on Classic — 🚧 ACTIVE — DEPLOYED, Version `a7dfd8f7`, awaiting FIX-EMISSIVE-1 / -2. (Shipped from `7f20e8e`, which also…
