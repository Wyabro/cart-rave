...
> Generated 2026-08-15 at commit `747e67d` on `cart-clash`. If docs/STATUS.md's digested sections have changed since, `npm run briefing:check` (inside `npm run qa`) fails until this is regenerated.
> Source digest: `56a5bf38`
...
GAMEPAD-FRIENDS-SEATED-PT-1 `[solo]` — hard-refresh prod, seat in FRIENDS with a pad
