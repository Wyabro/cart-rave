...
> Generated 2026-08-15 at commit `8c2e3f8` on `cart-clash`. If docs/STATUS.md's digested sections have changed since, `npm run briefing:check` (inside `npm run qa`) fails until this is regenerated.
> Source digest: `f47a4d1b`
...
GAMEPAD-FRIENDS-SEATED-1 — controller nav after seating in Friends lobby. Plan → ack before a lever
