...
> Generated 2026-08-20 at commit `a1b362dc` on `cart-clash`. If docs/STATUS.md's digested sections have changed since, `npm run briefing:check` (inside `npm run qa`) fails until this is regenerated.
> Source digest: `754902f9`
...
- **CART-POP-1** carts pop off the floor in normal driving — Wave G active; support-loss timeline
