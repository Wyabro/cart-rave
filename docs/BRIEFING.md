...
> Generated 2026-08-15 at commit `928df0d` on `cart-clash`. If docs/STATUS.md's digested sections have changed since, `npm run briefing:check` (inside `npm run qa`) fails until this is regenerated.
> Source digest: `e4621c30`
...
STOREROOMS-NPC-SELFKO-PT-1 / PT-2 — Solo Storerooms after push (`npm run dev` until ship)
