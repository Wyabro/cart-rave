...
> Generated 2026-08-10 at commit `c15333b` on `cart-clash`. If docs/STATUS.md's digested sections have changed since, `npm run briefing:check` (inside `npm run qa`) fails until this is regenerated.
> Source digest: `1fcc6868`
...
NOW: FRIENDS-JOIN-LAYOUT-1 — implemented locally; explicit ship + Wyatt production visual PASS remain
