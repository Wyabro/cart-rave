...
> Generated 2026-09-14 at commit `25bf1b38` on `cart-clash`. If docs/STATUS.md's digested sections have changed since, `npm run briefing:check` (inside `npm run qa`) fails until this is regenerated.
> Source digest: `fe479703`
...
- **SITE-TRUST-1** public information and analytics choice — shipped `25bf1b38` Worker `2ac86fc0`; SITE-TRUST-PT-1 owed
