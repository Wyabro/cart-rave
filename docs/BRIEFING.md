...
> Generated 2026-08-15 at commit `43a0c0b` on `cart-clash`. If docs/STATUS.md's digested sections have changed since, `npm run briefing:check` (inside `npm run qa`) fails until this is regenerated.
> Source digest: `d5bae2e5`
...
PATTERNS-UI-3-PT-1 — local: Maze scale plus Honeycomb / Diamond / Cubes coverage. Production after `ship it`
