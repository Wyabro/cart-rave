...
> Generated 2026-07-30 at commit `f98f9df` on `cart-clash`. If docs/STATUS.md has changed since, `npm run health:check` fails until this is regenerated.
> Source digest: `628576d6`
...
Pass looks like: ▶ DEPLOYED 07-30 `f98f9df` (Version `a066a450`, entry `index-aQjYKjNu.js`, asset-verified + live chip render); awaiting Wyatt playtest ([card](./planning/cargo-hud-1.md))
...
- **CARGO-HUD-1** opponent cargo readout on the nameplate — ▶ DEPLOYED 07-30 `f98f9df` (Version `a066a450`, entry `index-aQjYKjNu.js`, asset-verified + live chip…
