...
> Generated 2026-08-11 at commit `ae92e62` on `cart-clash`. If docs/STATUS.md's digested sections have changed since, `npm run briefing:check` (inside `npm run qa`) fails until this is regenerated.
> Source digest: `7ac19bd7`
...
NIGHT-SHIFT-BLOCKOUT-1: in Solo Dev, load `?level=rooftop`; drive over all three AC pads and check both roof landings, the stronger center launch, and no repeat bounce

Plan → Wyatt ack → apply. This heading names the card; it is **not** permission to edit.

Self-directed queue (one at a time, within the declared phase):
- **NIGHT-SHIFT-BLOCKOUT-1** Night Shift rooftop playable blockout — 🔧 Vent wave in progress. Four corner voids, two high roofs on inset utility plinths, two route ACs aimed at…
