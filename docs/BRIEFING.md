...
> Generated 2026-08-15 at commit `4e5ded3` on `cart-clash`. If docs/STATUS.md's digested sections have changed since, `npm run briefing:check` (inside `npm run qa`) fails until this is regenerated.
> Source digest: `144932af`
...
CONN-TOASTS-1 — friends join/leave toasts shipped; playtest owed (BACKLOG `## Playtest owed`)
