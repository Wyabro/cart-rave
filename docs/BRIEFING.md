...
> Generated 2026-08-15 at commit `b863c56` on `cart-clash`. If docs/STATUS.md's digested sections have changed since, `npm run briefing:check` (inside `npm run qa`) fails until this is regenerated.
> Source digest: `1cd083b5`
...
STORE-PILE-PT-1 — retest after STORE-PILE-2 ships. Same card id. Hard-refresh prod first
