...
> Generated 2026-08-10 at commit `5ea9c4b` on `cart-clash`. If docs/STATUS.md's digested sections have changed since, `npm run briefing:check` (inside `npm run qa`) fails until this is regenerated.
> Source digest: `e0e40bd8`
...
NOW: NPC-BOOST-1 and AI-EASY-SOFTEN-1 are deployed on Worker `4e4fd25a-452b-40b6-adb8-c8e1c41d6bde`: intent-based charged attacks, instant chase/escape/recovery, hard unsafe cancellation, difficulty charge envelopes, and Easy decisions 10% slower. QA, build, live HTML, 62 hashed assets, and both bundle markers pass. Await NPC-BOOST-PT-1 [2pc]
