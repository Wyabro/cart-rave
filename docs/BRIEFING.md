...
> Generated 2026-08-11 at commit `4f8d3a3` on `cart-clash`. If docs/STATUS.md's digested sections have changed since, `npm run briefing:check` (inside `npm run qa`) fails until this is regenerated.
> Source digest: `3078b4d2`
...
NIGHT-SHIFT-BLOCKOUT-1: in Solo Dev, load `?level=rooftop`; confirm the square roof, four diagonal corner spawns facing center, both lateral roof launches, and both stronger vertical launches

Plan → Wyatt ack → apply. This heading names the card; it is **not** permission to edit.

Self-directed queue (one at a time, within the declared phase):
- **NIGHT-SHIFT-BLOCKOUT-1** Night Shift rooftop playable blockout — 🔧 Revised local blockout ready. One static square roof; four supported diagonal corner spawns face center;…
