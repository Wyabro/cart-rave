...
> Generated 2026-08-18 at commit `a41987e7` on `cart-clash`. If docs/STATUS.md's digested sections have changed since, `npm run briefing:check` (inside `npm run qa`) fails until this is regenerated.
> Source digest: `5b0094b9`
...
Playtest CUSTOMIZE-SPAM-PT-1 on prod (`?diag=1`). Hard-refresh
