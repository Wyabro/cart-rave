...
> Generated 2026-08-15 at commit `19437ed` on `cart-clash`. If docs/STATUS.md's digested sections have changed since, `npm run briefing:check` (inside `npm run qa`) fails until this is regenerated.
> Source digest: `250fc2d2`
...
MENU-CMD-SKEW-PT-1 — main menu labels upright on prod (hard-refresh)
