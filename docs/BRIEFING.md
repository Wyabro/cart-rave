...
> Generated 2026-08-04 at commit `296a7b9` on `cart-clash`. If docs/STATUS.md's digested sections have changed since, `npm run briefing:check` (inside `npm run qa`) fails until this is regenerated.
> Source digest: `0d91014c`
...
Pass looks like: ▶ ACTIVE. Wave 1 DEPLOYED 08-03 (`aeb83aa`, Worker `7aa288d7`) — prod chunk fetched and checked. Waves 2–4 are gated on one capture: PERF-INSTR-1.
