...
Then open **http://127.0.0.1:4000/** to play. The client automatically connects to the local worker running on **port 8899** (see local environment detection in `src/netcode.js`).
