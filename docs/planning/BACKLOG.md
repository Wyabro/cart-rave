...
| **3** — WYATT LANE (blocked on you) | 👤 ongoing | **PA-COMBO-PT-1** · **MENU-MUSIC-PT-1** · ANNOUNCER-RERECORD-1 · SHIP-1 D-tier cut/keep |
...
| 🟢 [Playtest owed](#playtest-owed) | 15 | 0 | 12 | 3 |
...
| Medium | MENU-MUSIC-PT-1 — menu plays both songs, never under the game `[solo]` | **Owed: Wyatt playtest — MENU-MUSIC-PT-1 — the menu plays one song at a time and dies when Solo starts.** Parent MENU-MUSIC-2. Prod after hard-refresh. Deployed `11e5e48f`.<br>1. Open the menu. One song starts.<br>2. Start Solo. Menu music stops. Arena music only.<br>3. Quit to menu. One menu song starts. FAIL if silence, both songs at once, or menu music under the game. |
