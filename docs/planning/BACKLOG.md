...
| 🟢 [Playtest owed](#playtest-owed) | 5 | 0 | 2 | 3 |
...
| Pri | Item | Notes |
|-----|------|-------|
| High | NIGHT-SHIFT-CITY-1 — Night Shift visual-structure pass | **ACTIVE 08-11 — Wyatt ack.** The working name is not final. Freeze the approved square roof, spawn locations, raised roofs, and AC physics. Lever A: deterministic visual plan for the main tower shell, corner-deck supports, rooftop penthouse masses, and near/mid/far skyline bands. Lever B: causal worn concrete/roofing and facade material maps; no pristine hero surfaces. Lever C: moon key, warm city depth, fog separation, and explicit Low versus Medium/High density. Use instancing/material batching; no per-window lights. Verify fixed design/near/far views, no-post readability, disposal, render counts, QA/build, then Wyatt visual playtest. |
...
| Medium | UI-SCALE-P2-MEDIA-1 — Pass 2 media-query cleanup `[solo]` | **Owed: Wyatt playtest — UI-SCALE-P2-MEDIA-1 — drifted breakpoints reconciled to 380/768/1024/1025 contract, size-only 380px blocks deleted.** Deployed `b5e1d758` · prefer **https://www.cartclash.lol/?diag=1**.<br>1. Phone ≤768px: HUD lobby single-column, score labels hidden, nametags legible, menu stacked column scrolls correctly.<br>2. Tablet 768–1024px: lobby single-column, results landscape at ≤1024px.<br>3. Desktop ≥1025px: score labels visible, lobby two-column, results wide layout.<br>4. FAIL on broken layout, missing elements, or clipping at any breakpoint. |
| Low | ORIENT-HINT-SCROLL-1 — portrait-hint clips last menu item `[solo]` | **Owed: Wyatt playtest — ORIENT-HINT-SCROLL-1 — stacked mobile band now clears the 36px portrait-hint bar.** Deployed `b5e1d758` · prefer **https://www.cartclash.lol/?diag=1**.<br>1. 740×360 coarse landscape: open menu, scroll to bottom — last item must be fully visible, not clipped by the portrait-hint bar.<br>2. Portrait phone: no extra dead space at bottom of menu (padding should be normal).<br>3. FAIL if last item clips or if portrait has excessive bottom padding. |
...
NIGHT-SHIFT-BLOCKOUT-1, CART-MODEL-1, SHADES-MAT-1, MENU-CART-1, FRIENDS-JOIN-LAYOUT-1, FRIENDS-LEVEL-1, FRIENDS-LEVEL-PT-1, ONBOARD-ATTRACT-1,
ONBOARD-ART-1,
