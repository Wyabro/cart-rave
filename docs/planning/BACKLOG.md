...
| **3** — WYATT LANE (blocked on you) | 👤 ongoing | **STOREROOMS-NPC-SELFKO-PT-1 / PT-2** · SHIP-1 D-tier · **WARM-QP-ROTATE-PT-1** (after ship) |
...
engineering. Live owed checks: **STOREROOMS-NPC-SELFKO-PT-1** · **STOREROOMS-NPC-SELFKO-PT-2**
(dev until ship) · **WARM-QP-ROTATE-PT-1** (after ship) · **SHARD-PT-2** (launch day). Closed PASS history lives only in
[completed-work.md](./completed-work.md).
