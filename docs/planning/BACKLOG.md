...
|---|---:|---:|---:|---:|
| [Engineering](#engineering) | 17 | 5 | 4 | 7 (+1 partial) |
...
6. **SHARE-CARD-1** — update OG/social share image.
...
| High | SHARE-CARD-1 — update OG/social share image | **Filed 08-19.** Replace `public/brand/share-card.png` with current Cart Clash branding. Point `og:image` / `twitter:image` / JSON-LD at the new asset. Check crop and readability at 1200×630 share-card sizes. Not a reopen of SEO-1. |
...
NPC-SELFKO-3, NPC-SELFKO-3-PT-1, CART-POP-1, CART-POP-PT-1.
