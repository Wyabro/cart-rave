...
| **5** — SWEEP (cheap Lows) | 🟡 queued | SUNDIAL-LOW-WATER-1 · UI-SCALE-P2-MEDIA-1 · ORIENT-HINT-SCROLL-1 |
...
1. **SUNDIAL-LOW-WATER-1** — Low still skips ocean normal; check cost on Intel min-spec box.
2. **UI-SCALE-P2-MEDIA-1** — Pass 2 media-query cleanup; re-check phone per file.
3. **ORIENT-HINT-SCROLL-1** — landscape stacked column + portrait-hint clip.
...
MENU-SWAP-FLASH-1.
ANLX-GEO-1, ANLX-PAGEHOST-1, ANLX-GLITCH-1, DEV-LOOP-1, DEPLOY-MAP-1, MENU-SFX-1, CAPTURE-RING-LIMIT-1, CARGO-LATCH-1, CARGO-LATCH-PT-1, NPC-BOOST-2, NPC-BOOST-2-PT-1, NPC-BOOST-1, AI-EASY-SOFTEN-1, BOOTH-RAIL-COL-1.
