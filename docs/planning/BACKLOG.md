...
| **H** — principal-engineering audit batch (12 open, 3 closed) | 🟡 in progress | H1 3/7 landed 08-07 (desk-only, not deployed). Next unstarted: **GAMEPAD-LOBBY-1** — the one High, a pad-only player cannot use the Friends lobby at all. Detail below in Block H. |
...
|---|---:|---:|---:|---:|
| [Engineering](#engineering) | 27 | 0 | 16 | 10 (+1 partial) |
| [Art](#art) | 16 | 2 | 4 | 10 |
| [Audio](#audio) | 5 | 0 | 3 | 2 |
...
**H1 — correctness (7 items, all S/M effort, land as their own commits). 3/7 landed 08-07,
unpushed-to-prod desk-only fixes — no playtest owed. Writeup:
[completed-work.md](./completed-work.md).**
