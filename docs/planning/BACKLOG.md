...
|-------|-------|-------------|
| **1** — NOW (player-facing correctness) | ✅ clear | No High open rows (STORE-PILE-2 landed; retest STORE-PILE-PT-1) |
...
**STORE-PILE-PT-1** (retest after STORE-PILE-2). Closed PASS history lives only in
[completed-work.md](./completed-work.md).
...
SUNGLASSES-OBSIDIAN-PT-1, STORE-PILE-2.
