...
| High | **HOST-ROLE-1 — weak host poisons every peer** | **Lever 3 shipped** `80ecbf6` / `index-DWDp_cX_.js` — lobby hostScore rebalance (machine, not network). **Lobby retest open.** |
