...
| **3** — WYATT LANE (blocked on you) | 👤 ongoing | **MENU-CMD-SKEW-PT-1** · **STOREROOMS-NPC-SELFKO-PT-1 / PT-2** · SHIP-1 D-tier · **WARM-QP-ROTATE-PT-1** (after ship) |
...
| [Art](#art) | 1 | 0 | 0 | 1 |
| [Audio](#audio) | 1 | 0 | 0 | 1 |
| [Design / Gameplay](#design--gameplay) | 4 | 0 | 4 | 0 |
...
engineering. Live owed checks: **MENU-CMD-SKEW-PT-1** · **STOREROOMS-NPC-SELFKO-PT-1** · **STOREROOMS-NPC-SELFKO-PT-2**
(prod) · **WARM-QP-ROTATE-PT-1** (after ship) · **SHARD-PT-2** (launch day). Closed PASS history lives only in
[completed-work.md](./completed-work.md).
...
| Pri | Item | Notes |
|-----|------|-------|
| Medium | NAME-VARIETY-1 — expand NPC and player-name variety | **Approved 08-15 (Approach A).** Add 10 personality-mapped NPC names, 10 fixed first-run player names, and 10 reroll word parts (5 prefixes + 5 suffixes). Keep NPC/player pools distinct, preserve the four NPC personality types, and keep the Cart Clash retail-chaos / KO-friendly tone. Verification: pool integrity + deterministic generator coverage + `npm run qa`. Owed after landing: separate NPC-name and player-name playtests. |
