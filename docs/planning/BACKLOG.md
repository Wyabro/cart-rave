...
| Pri | Item | Notes |
|-----|------|-------|
| High | NPC-BOOST-2-PT-1 — charged and instant NPC boosts `[2pc]` | **NOW.** Unparked 08-10 after DEV-LOOP-1. Prior NPC-BOOST-PT-1 **FAIL**. Code already on prod.<br>1. Hard-refresh Solo with three NPCs. PASS if each difficulty visibly produces charge-ups in safe attacks, Easy least / Hard most, host hears each charge loop.<br>2. Friends room: both clients see telegraph, hear charge loop, see charged burst.<br>3. Classic rim + hole; octagon + square-hole: unsafe charge cancels / unsafe instant skipped.<br>4. FAIL on NPC boost self-KO, missing charge sound, desync, or reversed difficulty order. |
