...
- Art/background/presentation Lows: sunglasses materials.
...
**08-13 export — 6 PASS / 1 FAIL / 3 SKIP; six PASS cards removed:**
**ART-PALETTE-PT-1 · CHAL-SHELF-FIT-PT-1 · GAMEPAD-NAV-REPEAT-PT-1 · LOD-DOORWAY-PT-1 ·
RUMBLE-STRENGTH-PT-1 · SHELF-RAIL-PT-1**. Parents **GAMEPAD-NAV-REPEAT-1 · RUMBLE-STRENGTH-1 ·
CHAL-SHELF-FIT-1** close with their checks; **LOD-DOORWAY-1 · SHELF-RAIL-1 · ART-PALETTE-1**
were already closed. ART-PALETTE-PT-1's custom-hue-red note is filed fresh as **CART-HUE-RED-1**.
**KO-DOOMED-PT-1 FAILed** (no visible local-KO feedback) and was fixed — the host KO fan-out now
passes the local-victim hook; retest on `npm run dev:local`. **CARGO-BAY-INSTANCE-PT-3 ·
CONN-TRACK-LEAK-PT-1 · SHARD-PT-2** remain open. Detail: [completed-work.md](./completed-work.md).
