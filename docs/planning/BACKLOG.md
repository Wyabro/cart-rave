...
Landed 09-14 — **SITE-TRUST-1** (privacy, terms, contact, analytics choice, branded 404); **SITE-TRUST-PT-1** owed on prod `25bf1b38`.
...
| Pri | Item | Notes |
|-----|------|-------|
| High | SITE-TRUST-1 — public information and analytics choice | **Shipped 09-14** prod `25bf1b38` Worker `2ac86fc0-f463-4f69-88cf-71b720fb903f`. Critical: static routing. Publisher Redshift Studios; support redshiftstudiossupport@gmail.com; analytics on by default per Wyatt. Settings links to privacy choice, terms, and email. All optional provider loaders respect saved off. Public pages load no game or analytics. Preserve real 404 status and API/multiplayer routes. PNG uses a reduced palette (1,137,264 to 300,645 bytes). Checks: default/saved/URL choice, blocked storage, route tests, build, QA 2,432/2,432, VERIFY_OK `index-DuRqnkJB.js`. Playtest: **SITE-TRUST-PT-1**. No claim of legal compliance or human PASS. |
...
| Pri | Item | Notes |
|-----|------|-------|
| Low | SITE-TRUST-PT-1 — privacy choice and public pages `[solo]` | **Owed: Wyatt playtest — SITE-TRUST-PT-1 — privacy controls and public pages work.** Parent **SITE-TRUST-1**. Prod `25bf1b38` (Worker `2ac86fc0`, hard-refresh https://www.cartclash.lol/).<br>1. Open Settings. Open Privacy & Analytics. Confirm Redshift Studios and the support email.<br>2. Turn analytics off. Return to the game. Reopen the privacy page; the off choice stays saved. Turn it on again.<br>3. Check Terms and the contact link. Do not send a test email.<br>4. On a phone-sized window, confirm readable text and usable controls. Open an unknown path; confirm the branded 404 and return link.<br>5. PASS if the choice persists and all links work. Otherwise record the failing step. |
