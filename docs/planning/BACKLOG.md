...
|-------|-------|-------------|
| **1** — NOW (player-facing correctness) | 🟡 queued | **NET-LAG-1** wave 1 landed · **NET-LAG-1-PT-1** `[2pc]` · 9 playtest blockers |
