...
| **2** — PRE-SHIP (before public post) | 🟡 queued | all landed, PT owed (**KO-CENTER-RING-PT-1** · **CUSTOMIZE-SVG-FLASH-PT-1** · **COUNTDOWN-HOST-STAMP-PT-1** · **FRIENDS-LOBBY-ORDER-PT-1**) |
...
|---|---:|---:|---:|---:|
| [Engineering](#engineering) | 22 | 0 | 9 | 12 (+1 partial) |
...
Landed 08-17 — **SD-SPECTATOR-CHARGE-1** (gate ram-boost charge for SD spectators); playtest
**SD-SPECTATOR-CHARGE-PT-1** PASS 08-17 (automated solo rig + Wyatt) — parent closes.
...
3. 08-16 audit Lows, top first: **SPILL-DOUBLE-VFX-1** · **PODIUM-DOUBLE-CREDIT-1** · **KEYUP-STUCK-1** · **HOST-PRESENT-ORDER-1** · **ZOMBIE-ROOM-RESET-1** · **DEMOTE-COUNTDOWN-1** · **SPECTATOR-ANNOUNCER-1** · **RD-COUNTER-1**.
