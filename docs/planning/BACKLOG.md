...
| **2** — PRE-SHIP (before public post) | 🟡 queued | all landed, PT owed (**CUSTOMIZE-SVG-FLASH-PT-1** · **COUNTDOWN-HOST-STAMP-PT-1** · **FRIENDS-LOBBY-ORDER-PT-1**) |
...
|---|---:|---:|---:|---:|
| [Engineering](#engineering) | 20 | 0 | 7 | 12 (+1 partial) |
