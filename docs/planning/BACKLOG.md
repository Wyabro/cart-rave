...
| **2** — PRE-SHIP (before public post) | 🟡 queued | ONBOARD-ART-1 · VOICE-BUS-1 · CHUNK-DEFER-1 · NPC-BOOST-1 (measure) · UI-FRAME-1 + ESC-PANEL-1 · KILLFEED-PHONE-1 · ARENA-BUMPER-HINT-1 (after product call) |
...
6. **KILLFEED-PHONE-1** — kill feed awkward/overlapping on phone.
7. **ARENA-BUMPER-HINT-1** — menu advertises LB/RB arena; nothing reads bumpers. Product call first (wire or drop the hint).
