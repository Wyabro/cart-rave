...
| **5** — SWEEP (cheap Lows) | 🟡 queued | BOOTH-RAIL-COL-1 · SUNDIAL-LOW-WATER-1 · UI-SCALE-P2-MEDIA-1 · ORIENT-HINT-SCROLL-1 |
...
|---|---:|---:|---:|---:|
| [Engineering](#engineering) | 16 | 0 | 8 | 7 (+1 partial) |
| [Art](#art) | 10 | 1 | 2 | 7 |
| [Audio](#audio) | 3 | 0 | 2 | 1 |
...
1. **BOOTH-RAIL-COL-1** — Storerooms booth rails visual-only (posts only if picked up).
2. **SUNDIAL-LOW-WATER-1** — Low still skips ocean normal; check cost on Intel min-spec box.
3. **UI-SCALE-P2-MEDIA-1** — Pass 2 media-query cleanup; re-check phone per file.
4. **ORIENT-HINT-SCROLL-1** — landscape stacked column + portrait-hint clip.
5. Opportunistic Low neighbors when idle: **MOTION-A11Y-1** (needs definition of done first) · **CARGO-LATCH-1** (fix deployed — playtest owed) · **COUNTDOWN-QUICKPLAY-1** · **countdown survives menu return**.
...
MENU-SWAP-FLASH-1.
ANLX-GEO-1, ANLX-PAGEHOST-1, ANLX-GLITCH-1, DEV-LOOP-1, DEPLOY-MAP-1, MENU-SFX-1, CAPTURE-RING-LIMIT-1.
