...
| **2** — PRE-SHIP (before public post) | 🟡 queued | 08-16 audit Mediums: SD-SPECTATOR-CHARGE-1 (**REMOTE-INPUT-STALE-1** landed, PT owed; **NPC-ABORT-BURST-1** landed, PT owed; **SD-SCORE-STALE-1** Wyatt PASS; **THOST-CEILING-1** PT FAIL 08-16; **GAMEPAD-FREEZE-1** · **ZOMBIE-HOST-PICK-1** Wyatt PASS) |
...
more engineering. Open owed checks: **THOST-CEILING-PT-1** (FAIL 08-16, retest) · **SHARD-PT-2**
