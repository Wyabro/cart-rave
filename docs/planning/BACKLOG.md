...
| **2** — PRE-SHIP (before public post) | 🟡 queued | SD-SPECTATOR-CHARGE-1 (**KO-CENTER-RING-1** landed, PT owed; **CUSTOMIZE-SVG-FLASH-1** landed, PT owed; **COUNTDOWN-HOST-STAMP-1** landed, PT owed; **FRIENDS-LOBBY-ORDER-1** landed, PT owed) |
...
| **5** — SWEEP (cheap Lows) | 🟡 queued | MOTION-A11Y-1 · COUNTDOWN-QUICKPLAY-1 · COUNTDOWN-LEAK-1 · MIG-KO-DROP-1 · 08-16 audit Lows |
