...
| Pri | Item | Notes |
|-----|------|-------|
| Medium | ANIM-BUGS-1 — animations.js entrance + lifecycle bugs | **Deployed** `d5fc9a0` / Worker `c319bb08-f87d-4ac6-be98-4771cd731c34`. Levers 1–6 on prod; QA 7/7; live root + 25 assets 0×404; animations chunk `animations-CoDgvy2n.js` carries pointer-capture + howto beat symbols. Human check: **ANIM-BUGS-PT-1**. |
