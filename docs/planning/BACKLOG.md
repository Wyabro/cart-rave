...
| **2** — PRE-SHIP (before public post) | 🟡 queued | SD-SPECTATOR-CHARGE-1 (**COUNTDOWN-HOST-STAMP-1** landed, PT owed; **REMOTE-INPUT-STALE-1** · **NPC-ABORT-BURST-1** Wyatt PASS 08-17; **SD-SCORE-STALE-1** Wyatt PASS; **THOST-CEILING-1** Wyatt PASS; **GAMEPAD-FREEZE-1** · **ZOMBIE-HOST-PICK-1** Wyatt PASS) |
...
|---|---:|---:|---:|---:|
| [Engineering](#engineering) | 22 | 0 | 7 | 14 (+1 partial) |
...
(`npm run dev` until ship) · **FRIENDS-LOBBY-ORDER-PT-1** (`npm run dev` until VERIFY_OK) ·
