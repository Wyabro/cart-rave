...
| **2** — PRE-SHIP (before public post) | 🟡 queued | 08-16 audit Mediums: SD-SPECTATOR-CHARGE-1 (**REMOTE-INPUT-STALE-1** landed, PT owed; **GAMEPAD-FREEZE-1** landed, PT owed; **NPC-ABORT-BURST-1** landed, PT owed; **SD-SCORE-STALE-1** Wyatt PASS; **THOST-CEILING-1** PT owed; **ZOMBIE-HOST-PICK-1** landed) |
...
| 🟢 [Playtest owed](#playtest-owed) | 8 | 0 | 7 | 1 |
