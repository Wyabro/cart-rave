...
|-------|-------|-------------|
| **1** — NOW (player-facing correctness) | 🟡 active | **CART-POP-1** Wave H: F8 gzip + Classic segments 11–12 · **CART-POP-PT-1** FAIL / remains open · **NET-LAG-1-PT-1** `[2pc]` parked by Wyatt · 8 playtest blockers |
...
| High | CART-POP-1 — carts pop off the floor in normal driving | **Wave H 08-20.** Event 1686 (Classic) contacts record segments 11–12 at (-1.16, 15.83). Isolated 16 wedges do not pop at rest; a drop impact still yields +12.7 dvy with restitution 0.05 (penetration correction). F8 now gzip-base64s so 2.5 MB timelines upload (350 KB request cap kept). Probe now records handleIndex/gen, shapeType, yaw, feature IDs, solverPoint, preWorldPlanarSpeed. No physics values changed. **CART-POP-PT-1 remains FAIL/open.** Need a supported +10 from preVy≈0 before a geometry change. Lane: **Critical**. |
