...
| Pri | Item | Notes |
|-----|------|-------|
| Medium | NIGHT-SHIFT-PICKER-1 — Night Shift selectable in the arena list | **Filed 09-18.** Follows NIGHT-SHIFT-CITY-2 PASS. Player can pick Night Shift and play a round. Not Quickplay. Catalog is `quickplay: false` today; load is `?level=rooftop` only. Lane: Standard. |
