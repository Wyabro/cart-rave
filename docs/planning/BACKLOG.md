...
| **3** — WYATT LANE (blocked on you) | 👤 ongoing | **MENU-CMD-SKEW-PT-1** · **STOREROOMS-NPC-SELFKO-PT-1 / PT-2** · **NAME-NPC-VARIETY-PT-1 / NAME-PLAYER-VARIETY-PT-1** (after ship) · SHIP-1 D-tier · **WARM-QP-ROTATE-PT-1** (after ship) |
| **4** — PERF RESIDUAL (measure-first) | 🟡 queued | **WARM-QP-ROTATE-1** · WARM-SOLO-1 · PERF-WATCH-1 · NET-PERF-1 / NET-PERF-3 |
| **5** — SWEEP (cheap Lows) | 🟡 queued | MOTION-A11Y-1 · COUNTDOWN-QUICKPLAY-1 · COUNTDOWN-LEAK-1 · CART-HUE-RED-1 |
...
| 🟢 [Playtest owed](#playtest-owed) | 9 | 1 | 5 | 3 |
...
more engineering. Open owed checks: **MENU-CMD-SKEW-PT-1** · **STOREROOMS-NPC-SELFKO-PT-1** · **STOREROOMS-NPC-SELFKO-PT-2**
(prod) · **NAME-NPC-VARIETY-PT-1 / NAME-PLAYER-VARIETY-PT-1** (after ship) · **WARM-QP-ROTATE-PT-1** (after ship) · **SHARD-PT-2** (launch day). Closed PASS history lives only in
[completed-work.md](./completed-work.md).
...
| Pri | Item | Notes |
|-----|------|-------|
| Medium | STOREROOMS-NPC-SELFKO-2 — Storerooms NPC unforced vortex / outer-edge self-KOs | New evidence 08-15. Residual after AI-ARENA-SELFKO-1. L1 `d680928` · L2 `928df0d`. PT: STOREROOMS-NPC-SELFKO-PT-1 · PT-2. |
...
dev`, or ship first. *(The NAME-VARIETY rows are now deployed and wait on Wyatt's eyes.)*
...
| Pri | Item | Notes |
|-----|------|-------|
| Low | NAME-NPC-VARIETY-PT-1 — expanded NPC names fit the roster `[solo]` | **Deployed Worker `b82ca48f-4a64-4b43-a87d-c0ff055da569`.** **Owed: Wyatt playtest — NAME-NPC-VARIETY-PT-1 — NPC names feel varied and belong in Cart Clash.** Parent **NAME-VARIETY-1**. Hard-refresh first.<br>1. Start Solo three times, reloading between rounds.<br>2. Read the three NPC names in each roster and during play.<br>3. FAIL if a roster repeats a name, a name is hard to read, or a name feels grim or outside the retail-cartoon tone. Random repeats between separate page loads are allowed. |
| Low | NAME-PLAYER-VARIETY-PT-1 — player defaults and rerolls feel varied `[solo]` | **Deployed Worker `b82ca48f-4a64-4b43-a87d-c0ff055da569`.** **Owed: Wyatt playtest — NAME-PLAYER-VARIETY-PT-1 — first-run and rerolled player names stay readable, playful, and less repetitive.** Parent **NAME-VARIETY-1**. Hard-refresh first.<br>1. Click the name reroll button 20 times.<br>2. Scan for repeated shapes, awkward combinations, overflow, or names outside the retail-brawl tone.<br>3. Open one private window to sample a fresh default name. FAIL if the name is unreadable, grim, or collides with an NPC name. |
| Medium | MENU-CMD-SKEW-PT-1 — main menu labels sit upright `[solo]` | **Owed: Wyatt playtest — MENU-CMD-SKEW-PT-1 — SOLO through SETTINGS letters stand upright.** Parent **MENU-CMD-SKEW-1**. Hard-refresh first.<br>1. Open the main menu on prod.<br>2. Look at SOLO, QUICKPLAY, FRIENDS, CUSTOMIZE, CHALLENGES, HOW TO PLAY, and SETTINGS.<br>3. FAIL if the letters lean left. PASS if the letters stand upright. The yellow selected bar may stay a slight slant. |
| Medium | STOREROOMS-NPC-SELFKO-PT-1 — Storerooms NPCs survive vortex rings `[solo]` | **Owed: Wyatt playtest — STOREROOMS-NPC-SELFKO-PT-1 — NPCs peel off a vortex before the pull commits, and still hunt the gutters.** Parent **STOREROOMS-NPC-SELFKO-2**. Prod Worker `cc79e3b7` (`524b96a`). Hard-refresh first.<br>1. Solo Storerooms, Medium, one full round.<br>2. Watch NPCs near the four vortex rings.<br>3. FAIL if two or more unforced vortex drops in one round, or they refuse the gutters. |
| Medium | STOREROOMS-NPC-SELFKO-PT-2 — Storerooms NPCs stay off the outer pit `[solo]` | **Owed: Wyatt playtest — STOREROOMS-NPC-SELFKO-PT-2 — NPCs do not drive themselves off the outer floor with no ram.** Parent **STOREROOMS-NPC-SELFKO-2**. Prod Worker `cc79e3b7` (`524b96a`). Hard-refresh first.<br>1. Solo Storerooms, Medium, one full round.<br>2. Watch the outer floor edge.<br>3. FAIL if an NPC drives itself off the pit with no ram. |
...
| High | PATTERNS-FOIL-PT-1 — earned patterns show foil, Honeycomb and Diamond stay lit `[solo]` | **Deployed Worker `1cdbcdb9` (`c4f46bc`).** **Owed: Wyatt playtest — PATTERNS-FOIL-PT-1 — foil slides on earned patterns; Honeycomb and Diamond interiors stay neon; the chip says Cubes.** Parent **PATTERNS-FOIL-1**. Hard-refresh https://www.cartclash.lol/ first.<br>1. Open CUSTOMIZE → PATTERN. Pick Pink. Confirm the chip says Cubes, not Isometric Cubes.<br>2. Spin Maze, Waves, Bolt, and Cubes. PASS if a spectral sheen moves on the cart. FAIL if Classic, Stripes, or Checker flash foil.<br>3. Select Honeycomb, then Diamond Weave. PASS if the interiors stay neon. FAIL if they go black.<br>4. Start Solo with Cubes. PASS if foil survives a KO and the cart is not a rainbow lamp. |
| Medium | PATTERNS-UI-5-PT-1 — prismatic Cubes is distinct from Honeycomb `[solo]` | **Parked 08-16 — PATTERNS-FOIL-1 is the active card.** Cubes-vs-Honeycomb now rides the grating. **Deployed Worker `ae965403-9279-4776-9b4e-55f4955b7259`; live assets verified. Owed: Wyatt playtest — PATTERNS-UI-5-PT-1 — Isometric Cubes is smaller, visibly faceted, and immediately distinct from Honeycomb; Diamond Weave stays unchanged.** Parent **PATTERNS-UI-5**. **PATTERNS-UI-4-PT-1 FAIL 08-15:** Maze, Honeycomb, and Diamond passed; Cubes was still too close to Honeycomb.<br>1. Hard-refresh production, open CUSTOMIZE → PATTERN, and select Pink.<br>2. Select Isometric Cubes. PASS if seven compact repeats span one texture width, each cube shows three tinted faces plus a bright top glint, and it does not read as Honeycomb.<br>3. Switch between Honeycomb and Isometric Cubes from front, side, and rear views. PASS if they are immediately distinct. Select Diamond Weave. PASS if it is unchanged.<br>4. Repeat steps 2–3 with Blue, then start a solo round. PASS if Cubes stays stable while moving and after a KO rebuild. |
