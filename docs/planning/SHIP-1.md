...
| # | Item | Notes |
|---|------|-------|
| A1 | Host hitch forensics → capability-based host preference | **Mostly closed.** Tab-out latch VALIDATED 07-21; COUNTDOWN-WARM-1 / SYNC-1 PASS 07-22; Intel-as-host PASS 07-22; HOST-ROLE-1 lobby rebalance PASS 07-20 (`80ecbf6`). **HOST-CAP-1 residual 07-31:** weak-host toast when local hosts with join-time `score < 50` (once per hostship); min-spec fact accepted. Coded unpushed until ship. |
